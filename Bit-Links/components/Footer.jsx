      ...
      <div className='container mx-auto px-4'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div className='space-y-4'>
            <h2 className='text-xl font-bold'>BitLinks</h2>
            <p className='text-indigo-100'>
              The most reliable URL shortener for professionals.
            </p>
            <p className='text-indigo-200 text-sm'>
              Created by Bishwa Bandhu Parmar
            </p>
          </div>
          ...
          <div>
            ...
            <ul className='space-y-2'>
              <li className='flex items-center gap-2 hover:text-indigo-200 transition-colors cursor-pointer'>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>contact@bitlinks.com</span>
              </li>
              <li className='flex items-center gap-2 hover:text-indigo-200 transition-colors cursor-pointer'>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className='border-t border-indigo-500 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center'>
          ...
          <div className='flex space-x-4'>
            <Link href="#" className='hover:text-indigo-200 transition-colors cursor-pointer'>
